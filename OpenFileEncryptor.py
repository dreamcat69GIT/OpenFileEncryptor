...
def download_file(url, filename):
    ...
    data = response.json()
    current_verison = data["current_version"]
    new_filename = f"{filename.split('.')[0]}_{current_verison}.exe"
...
def switch_language():
    ...
    if Language == 'English':
        ...
        version_label_lan = 'Version 1.1.2'
        ...
        version_label_lan = 'Версия 1.1.2'
