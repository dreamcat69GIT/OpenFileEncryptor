...
def read_settings():
    global Language, Language_restore, Logs
    config = configparser.ConfigParser()
    try:
...
def switch_language():
    global select_dir_button_enc_lan, path_entry_enc_lan, pin_entry_enc_lan, encryption_button_lan, check_box_lan, check_box_log_lan, select_dir_button_dec_lan, path_entry_dec_lan, pin_entry_dec_lan, decryption_button_lan, seg_button_lan_1, seg_button_lan_2, seg_button_lan_3, save_settings_lan, save_key_button_lan, upload_from_file_entry_enc_lan, text_enc
    if Language == 'English':
...
def settings():
    global save, close, language_menu, check_box_log, check_box_log_var, copyright_label_1, copyright_label_2
