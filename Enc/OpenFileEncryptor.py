...
def settings():
    ...
    copyright_label_1 = customtkinter.CTkLabel(app, text='CherretGit_(GUI) ', fg_color='#FF4500')
    copyright_label_1.place(x=0, y=472)
    copyright_label_1.bind("<Button-1>", copyright_callback_1)
    copyright_label_2 = customtkinter.CTkLabel(app, text='dreamcat69GIT_(PROGRAM) ', fg_color='#FF4500')
    copyright_label_2.place(x=235, y=472)
